...
# insert users
#db.add_all stages the sql queries
db.add_all([
...
# insert posts. Posts must be included after user creation as user id is required 
db.add_all([
...
#db.commit commits the queries to the database
db.commit()
